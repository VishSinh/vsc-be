...
class DashboardView(APIView):
    ...
    def get(self, request):
        ...
        medium_stock_items = AnalyticsService.get_medium_stock_items()
        ...
        return {
            ...
            "medium_stock_items": medium_stock_items,
...
class DetailedAnalyticsView(APIView):
    ...
    def get(self, request):
        ...
        data_fetchers = {
            ...
            AnalyticsType.MEDIUM_STOCK_CARDS: AnalyticsService.get_medium_stock_cards_list,
        ...
        if analytics_type in (AnalyticsType.YEARLY_PROFIT, AnalyticsType.YEARLY_SALE):
            ...
            return results
        elif analytics_type == AnalyticsType.PENDING_ORDERS:
            # Same nested serialization as TODAYS_ORDERS for pending orders list
            queryset = fetcher()
            results = []
            for order in queryset:
                order_data = model_unwrap(order)
