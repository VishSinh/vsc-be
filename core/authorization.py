...
class RolePermissions:
    ...
    ADMIN_PERMISSIONS = [
            value for name, value in Permission.__dict__.items()
            if not name.startswith("__") and not callable(value)
        ]
    
    MANAGER_PERMISSIONS = [
        # Management level access
        Permission.ACCOUNT_READ, Permission.ACCOUNT_UPDATE, Permission.ACCOUNT_LIST,
        Permission.INVENTORY_CREATE, Permission.INVENTORY_READ, Permission.INVENTORY_UPDATE, Permission.INVENTORY_LIST, Permission.INVENTORY_TRANSACTION,
        Permission.ORDER_CREATE, Permission.ORDER_READ, Permission.ORDER_UPDATE, Permission.ORDER_LIST, Permission.ORDER_APPROVE, Permission.ORDER_CANCEL,
        Permission.PRODUCTION_CREATE, Permission.PRODUCTION_READ, Permission.PRODUCTION_UPDATE, Permission.PRODUCTION_LIST,
        Permission.BILL_CREATE, Permission.BILL_READ, Permission.BILL_UPDATE, Permission.BILL_LIST, Permission.PAYMENT_PROCESS,
    ...
    STAFF_PERMISSIONS = [
        ...
        Permission.INVENTORY_READ, Permission.INVENTORY_LIST, Permission.INVENTORY_TRANSACTION,
        Permission.ORDER_CREATE, Permission.ORDER_READ, Permission.ORDER_UPDATE, Permission.ORDER_LIST,
        Permission.PRODUCTION_READ, Permission.PRODUCTION_LIST,
